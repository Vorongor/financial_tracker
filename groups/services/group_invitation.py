...
class GroupInvitationService:
    ...
    @classmethod
    def accept_group_invitation(cls, group_id: int, user_id: int) -> None:
    ...
    @classmethod
    def reject_group_invitation(cls, group_id: int, user_id: int) -> None:
        group = GroupMembership.objects.select_for_update().get(
            group_id=group_id, user_id=user_id
        )
    ...
    @classmethod
    def promote_group_member(cls, group_id: int, user_id: int) -> None:
        group = GroupMembership.objects.select_for_update().get(
            group_id=group_id, user_id=user_id
        )
        if not group:
    ...
    @classmethod
    def demote_group_member(cls, group_id: int, user_id: int) -> None:
        group = GroupMembership.objects.select_for_update().get(
            group_id=group_id, user_id=user_id
        )
        if not group:
    ...
    @classmethod
    def leave_group(cls, group_id: int, user_id: int) -> None:
